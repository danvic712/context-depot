...
{
    IReadOnlyList<MarkdownChunk> Chunk(string content);
}

public sealed partial class HeadingAwareMarkdownChunker : IMarkdownChunker
{
    public IReadOnlyList<MarkdownChunk> Chunk(string content)
    {
        ...
        void Flush()
        {
            ...
            chunks.Add(new MarkdownChunk(currentHeading, value, Hash(value)));
            currentLines.Clear();
        }
